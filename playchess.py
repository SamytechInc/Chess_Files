...
def main( modelFile, mode, color, num_rollouts, num_threads, fen, verbose ):
    ...
    cuda = False
    if cuda:
        weights = torch.load("C:/Users/samya/pytorch-alpha-zero/weights/AlphaZeroNet_20x256.pt")
    else:
        weights = torch.load("C:/Users/samya/pytorch-alpha-zero/weights/AlphaZeroNet_20x256.pt", map_location=torch.device('cpu') )
